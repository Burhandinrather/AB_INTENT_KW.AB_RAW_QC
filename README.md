...
Also, I have created the streams and tasks in Snowflake using SQL to capture some mandatory info regarding the data that gets appended every week. The SQL Script is present with name SQL Script.text file
